...
function translateUI(lang,locale,template){
  (function($, window, document) {
      $(function() {      
        ...
        selector.find("li:nth-child(7) .left span").text(clear(template.powershell));
        ...
        selector.find("li:nth-child(7) .help").text(clear(template.powershellDescription));
        selector.find("li:nth-child(8) .left span").text(clear(template.gntp));
