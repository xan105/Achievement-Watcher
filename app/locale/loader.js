...
function translateUI(lang,locale,template){
  (function($, window, document) {
      $(function() {      
        ...
        selector.find("li:nth-child(2) .left span").text(clear(template.powershell));
        ...
        selector.find("li:nth-child(2) .help").text(clear(template.powershellDescription));
        selector.find("li:nth-child(3) .left span").text(clear(template.gntp));
        selector.find("li:nth-child(3) .right select option[value='true']").text(clear(template.enable));
        selector.find("li:nth-child(3) .right select option[value='false']").text(clear(template.disable));
        selector.find("li:nth-child(4) .left span").text(clear(template.souvenir));
        selector.find("li:nth-child(4) .right select option[value='true']").text(clear(template.enable));
        selector.find("li:nth-child(4) .right select option[value='false']").text(clear(template.disable));
        selector.find("li:nth-child(4) .help").text(clear(template.souvenirDescription));
        selector.find("li:nth-child(5) .left span").text(clear(template.toastSouvenir));
        selector.find("li:nth-child(5) .right select option[value='0']").text(clear(template.hide));
        selector.find("li:nth-child(5) .right select option[value='1']").text(clear(template.toastSouvenir_header));
        selector.find("li:nth-child(5) .right select option[value='2']").text(clear(template.toastSouvenir_footer));
        selector.find("li:nth-child(5) .help").text(clear(template.toastSouvenirDescription));
