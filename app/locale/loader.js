...
function translateUI(lang,locale,template){
  (function($, window, document) {
      $(function() {      
        ...
        selector.find("li:nth-child(2) .left span").text(clear(template.thumbnailPortrait));
        selector.find("li:nth-child(2) .right select option[value='true']").text(clear(template.portrait));
        selector.find("li:nth-child(2) .right select option[value='false']").text(clear(template.landscape));
        selector.find("li:nth-child(3) .left span").text(clear(template.hiddenAch));
        selector.find("li:nth-child(3) .right select option[value='true']").text(clear(template.show));
        selector.find("li:nth-child(3) .right select option[value='false']").text(clear(template.hide));
        selector.find("li:nth-child(4) .left span").text(clear(template.mergeDuplicates));
        ...
        selector.find("li:nth-child(5) .left span").text(clear(template.timeMergeRecentFirst));
        selector.find("li:nth-child(5) .right select option[value='true']").text(clear(template.timeMergeRecent));
        selector.find("li:nth-child(5) .right select option[value='false']").text(clear(template.timeMergeOldest));
        selector.find("li:nth-child(5) .help").text(clear(template.timeMergeRecentFirstDescription));
        selector.find("li:nth-child(6) .left span").text(clear(template.hideZero));
        ...
        selector.find("li:nth-child(7) .left span").text(clear(template.legitSteam));
        selector.find("li:nth-child(7) .right select option[value='0']").text(clear(template.none));
        selector.find("li:nth-child(7) .right select option[value='1']").text(clear(template.installed));
        selector.find("li:nth-child(7) .right select option[value='2']").text(clear(template.owned));
        selector.find("li:nth-child(7) .help").text(clear(template.publicProfile)); 
        selector.find("li:nth-child(8) .left span").text(clear(template.importCache));
        selector.find("li:nth-child(8) .right select option[value='true']").text(clear(template.enable));
        selector.find("li:nth-child(8) .right select option[value='false']").text(clear(template.disable));
        selector.find("li:nth-child(8) .help").text(clear(template.importCacheDescription));
        ...
        selector.find("li:nth-child(6) .left span").text(clear(template.rumble));
        selector.find("li:nth-child(6) .right select option[value='true']").text(clear(template.enable));
        selector.find("li:nth-child(6) .right select option[value='false']").text(clear(template.disable));
        selector.find("li:nth-child(6) .help").text(clear(template.rumbleDescription)); 
        selector.find("li:nth-child(7) .left span").text(clear(template.notifyOnProgress));
        ...
        selector.find("li:nth-child(7) .help").text(clear(template.notifyOnProgressDescription));   
        selector.find("li:nth-child(8) .left span").text(clear(template.powershell));
        selector.find("li:nth-child(8) .right select option[value='true']").text(clear(template.enable));
        selector.find("li:nth-child(8) .right select option[value='false']").text(clear(template.disable));
        selector.find("li:nth-child(8) .help").text(clear(template.powershellDescription));
        selector.find("li:nth-child(9) .left span").text(clear(template.gntp));
        selector.find("li:nth-child(9) .right select option[value='true']").text(clear(template.enable));
        selector.find("li:nth-child(9) .right select option[value='false']").text(clear(template.disable));   
