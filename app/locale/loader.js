...
function translateUI(lang,locale,template){
  (function($, window, document) {
      $(function() {      
        ...
        selector.find("li:nth-child(5) .left span").text(clear(template.powershell));
        ...
        selector.find("li:nth-child(5) .help").text(clear(template.powershellDescription));
        selector.find("li:nth-child(6) .left span").text(clear(template.gntp));
